...
DATASET_EVALUATION=['Coffee','CBF','ECGFiveDays','Fish','GunPoint','ItalyPowerDemand','Mallat', 
				'NonInvasiveFetalECGThorax1', 'NonInvasiveFetalECGThorax2',
				'OSULeaf','Plane','StarLightCurves','Trace','TwoLeadECG','Wafer','Strawberry',
				'ToeSegmentation1','RefrigerationDevices','MiddlePhalanxTW',
				'MiddlePhalanxOutlineAgeGroup', 'Haptics', 'Herring', 'CinCECGTorso',
				'MedicalImages','Computers','Earthquakes','ECG200','FordA', 'FordB','ShapeletSim',
				'PhalangesOutlinesCorrect','GunPointAgeSpan','DistalPhalanxOutlineCorrect']

ITERATIONS = 5  # nb of random runs for random initializations

ARCHIVE_NAMES = ['UCRArchive']

dataset_names_for_archive = {'UCRArchive': DATASET_EVALUATION}

CLASSIFIERS = [ 'cnn', 'inception','resnet','mlp']
...
# WINDOW_NAMES = ['flat', 'hanning', 'hamming', 'bartlett', 'blackman','tukey']

# WINDOW_SIZES = [1, 5, 10, 20, 30, 50]
...
hyperparams = {'WINDOW_NAMES':['flat', 'hanning', 'hamming', 'bartlett', 'blackman','tukey'],
                'WINDOW_SIZES':[1, 5, 10, 20, 30, 50],
                'MAX_LOBES':[2, 3, 5, 7],
                'BATCHES':[1, 10, 20, 100, 500, 1000],
                'EPOCHS':[1, 5, 10, 20, 30]}
